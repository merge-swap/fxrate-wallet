...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "FXRateNetwork") type = FXRateNetwork;
    if(strType == "FXRateNetworkVariable") type = FXRateNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == FXRateNetwork) s = "FXRateNetwork";
    if(type == FXRateNetworkVariable) s = "FXRateNetworkVariable";
