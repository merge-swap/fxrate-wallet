 ...
 *
 *   // network
 *   CFXRateNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.fxrate.site/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CFXRateNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: FXRateNetwork
// //   -- signature requirements : Key1(User)
// class CFXRateNetworkVariable : public CGovernanceObject
// {
// private:
