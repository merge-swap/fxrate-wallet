    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("FXRate Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About FXRate Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  fxrate-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the FXRate in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 FXR, 0.1 FXR, 1 FXR and 10 FXR -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://fxratecoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://fxratecoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("FXRate Core is shutting down...") + "<br /><br />" +
