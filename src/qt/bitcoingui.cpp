    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("FXRate Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FXRate address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fxrate: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About FXRate Core"), this);
    aboutAction->setStatusTip(tr("Show information about FXRate Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FXRate Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FXRate addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FXRate addresses"));
    ...
    openAction->setStatusTip(tr("Open a fxrate: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the FXRate Core help message to get a list with possible FXRate Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("FXRate Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FXRate network", "", count));
}
...
{
    QString strTitle = tr("FXRate Core"); // default title
