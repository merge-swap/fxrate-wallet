    ...
    mapper(0)
{
    ...
    /* Theme selector */
    /*ui->theme->addItem(QString("FXR-light"), QVariant("light"));*/
    ui->theme->addItem(QString("FXR-blue"), QVariant("drkblue"));
    /*ui->theme->addItem(QString("FXR-Crownium"), QVariant("crownium"));*/
    ui->theme->addItem(QString("FXR-traditional"), QVariant("trad"));
