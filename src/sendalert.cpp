...
2. run fxrated with -printalert or -sendalert like this:
   /path/to/fxrated -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.fxrate.site";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/FXRate Core:0.12.0.58/"));
