...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("FXRate Core fxrate-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  fxrate-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fxrate transaction") + "\n" +
              "  fxrate-tx [options] -create [commands]   " + _("Create hex-encoded fxrate transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded fxrate transaction
