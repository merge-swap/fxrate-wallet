...
{
    if(fLiteMode) return; // ignore all FXRate related functionality
...
/*
    ...
    allow endless transaction that would bloat FXRate and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("fxrate-privatesend");
