...
This mechanism has been integrated into Bitcore-Node-FXRate which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/fxratecoin/insight-api-fxrate#web-socket-api](https://github.com/fxratecoin/insight-api-fxrate#web-socket-api) 
* API: [https://github.com/fxratecoin/insight-api-fxrate#instantsend-transactions](https://github.com/fxratecoin/insight-api-fxrate#instantsend-transactions) 
...
By default, the FXRate Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the FXRate Core daemon:
