...
This document provides guidelines for internationalization of the FXRate Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to FXRate network</numerusform>
            <numerusform>%n active connections to FXRate network</numerusform>
        </translation>
    </message>
