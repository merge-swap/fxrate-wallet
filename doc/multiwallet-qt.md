...
Only requiring some minor changes is fxrate.cpp.
...
Changes to fxrate.cpp
----------------------
fxrate.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
